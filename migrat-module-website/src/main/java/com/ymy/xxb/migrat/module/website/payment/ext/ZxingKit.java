...
package com.ymy.xxb.migrat.module.website.payment.ext;
...
import com.ymy.xxb.migrat.module.website.payment.util.IOUtils;
...
public class ZxingKit {
	...
	public static void main(String[] args) {
		...
		Boolean encode = encode("www.baidu.com", BarcodeFormat.QR_CODE, 3, ErrorCorrectionLevel.H, "png", 200, 200,
				saveImgFilePath);
		if (encode) {
