...
import com.ymy.xxb.migrat.module.biz.produce.mapper.InformTemplateMapper;
...
public class InformTemplateService extends BaseService{
	...
	/*-------------------自定义基类未实现接口-------------------*/
	public List<Map<String, Object>> templeList(String keyword) {
		return informTemplateMapper.templeList(keyword);
	}
