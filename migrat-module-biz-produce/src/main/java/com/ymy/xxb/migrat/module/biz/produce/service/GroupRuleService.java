...
import com.ymy.xxb.migrat.module.biz.produce.mapper.GroupRuleMapper;
...
public class GroupRuleService extends BaseService{
	...
	/*-------------------自定义基类未实现接口-------------------*/
	public List<Map<String, Object>> ruleList(String keyword) {
		return groupRuleMapper.ruleList(keyword);
	}
