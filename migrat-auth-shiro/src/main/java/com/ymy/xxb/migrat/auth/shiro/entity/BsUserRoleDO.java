...
public class BsUserRoleDO extends BaseVo{
	
	private static final long serialVersionUID = -135806837607426316L;

	/**
	 * 用户ID
	 */
	@ApiModelProperty(value = "用户ID", name = "bsUserId", dataType = "String", required = true)
